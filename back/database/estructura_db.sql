...
-- psql -U postgres -d wms_db -f estructura_db.sql

-- Para crear un usuario administrador inicial, usar el endpoint:
-- POST /api/auth/register
-- Body: {"nombre": "Admin", "email": "admin@wms.com", "password": "tu_password", "rol": "Administrador"}
